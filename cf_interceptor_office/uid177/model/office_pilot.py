...
class Cfg:
    def __init__(self) -> None:
        ...
        self.sh_zmin = _f("OP_SH_ZMIN", 0.15)
        ...
        self.sb_v = _f("OP_SB_V", 0.45)     # "motionless" speed threshold m/s
        self.sb_t = _f("OP_SB_T", 1.0)      # seconds of stall before firing
        ...
        self.sb_t0 = _f("OP_SB_T0", 1.5)    # never arm before this time
