...
class RoutePlanner:
    ...
    def plan(self, starts, clue, n: int, map_kind: str):
        ...
        # v2 is deliberately XY-only. Mountain pad placement can move nominal
        # Z by tens of metres, while the route output and objective are both XY.
        # Removing Z at runtime matches training and blocks that domain shift.
        padded[..., 2] = 0.0
        clue[..., 2] = 0.0
